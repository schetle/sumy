"""Tests for the TextRank summarizer."""
...
def test_single_sentence():
    """Test TextRank with a single sentence."""
...
def test_two_sentences():
    """Test TextRank with two sentences."""
...
def test_stop_words_correctly_removed():
    """Test that stop words are correctly removed from word sets."""
    summarizer = TextRankSummarizer()
...
def test_three_sentences_but_second_winner():
    """Test that the second sentence wins when it has the most connections."""
    document = build_document([
...
def test_sentences_rating():
    """Test that sentence ratings follow the expected ordering."""
    document = build_document([
        "a c e g",
        "a b c d e f g",
        "b d f",
