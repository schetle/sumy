"""Tests for the KL-divergence summarizer."""
...
def _build_summarizer(stop_words):
    """Build a KLSummarizer with given stop words.
...
def test_empty_document():
    """Test KL summarizer with an empty document."""
...
def test_single_sentence():
    """Test KL summarizer with a single sentence."""
...
def test_joint_freq():
    """Test joint frequency computation between two word lists."""
    summarizer = _build_summarizer(EMPTY_STOP_WORDS)
...
def test_kl_divergence():
    """Test KL divergence computation against known scipy values."""
    summarizer = _build_summarizer(EMPTY_STOP_WORDS)
    EPS = 0.00001
