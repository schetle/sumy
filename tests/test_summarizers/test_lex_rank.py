"""Tests for the LexRank summarizer."""
...
def test_tf_metrics():
    """Test TF metric computation for LexRank."""
...
def test_idf_metrics():
    """Test IDF metric computation for LexRank."""
    summarizer = LexRankSummarizer()
...
def test_modified_cosine_computation():
    """Test modified cosine similarity computation for LexRank."""
    summarizer = LexRankSummarizer()
...
def test_article_example():
    """Test LexRank summarizer on a real Czech article.
