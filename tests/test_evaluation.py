...
from sumy.evaluation import cosine_similarity, f_score, precision, recall, rouge_l_sentence_level, rouge_l_summary_level, rouge_n, unit_overlap
...
class TestRougeEvaluation(unittest.TestCase):
    ...
    def test_split_into_words(self):
        ...
        self.assertEqual(["One", "two", "two", "Two", "Three"], _split_into_words(sentences1))

        sentences2 = PlaintextParser.from_string("two two. Two. Three.", Tokenizer("english")).document.sentences
        self.assertEqual(["two", "two", "Two", "Three"], _split_into_words(sentences2))
    ...
    def test_recon_lcs(self):
        ...
        self.assertEqual(_recon_lcs("thisisatest", "testing123testing"), ("t", "s", "i", "t", "e", "s", "t"))
    ...
    def test_rouge_l_sentence_level(self):
        ...
        _candidate3 = PlaintextParser(candidate3_text, Tokenizer("english")).document.sentences
