...
def test_magnitude():
    ...
    assert abs(model.magnitude - 2.0) < 1e-7
...
def test_normalized_words_frequencies():
    ...
    assert abs(model.normalized_term_frequency("a") - 1/5) < 1e-7
    assert abs(model.normalized_term_frequency("b") - 2/5) < 1e-7
    assert abs(model.normalized_term_frequency("c") - 3/5) < 1e-7
    assert abs(model.normalized_term_frequency("d") - 4/5) < 1e-7
    assert abs(model.normalized_term_frequency("e") - 5/5) < 1e-7
    assert abs(model.normalized_term_frequency("z") - 0.0) < 1e-7
...
def test_normalized_words_frequencies_with_smoothing_term():
    ...
    assert abs(model.normalized_term_frequency("a", 0.5) - (0.5 + 1/10)) < 1e-7
    assert abs(model.normalized_term_frequency("b", 0.5) - (0.5 + 2/10)) < 1e-7
    assert abs(model.normalized_term_frequency("c", 0.5) - (0.5 + 3/10)) < 1e-7
    assert abs(model.normalized_term_frequency("d", 0.5) - (0.5 + 4/10)) < 1e-7
    assert abs(model.normalized_term_frequency("e", 0.5) - (0.5 + 5/10)) < 1e-7
    assert abs(model.normalized_term_frequency("z", 0.5) - 0.5) < 1e-7
