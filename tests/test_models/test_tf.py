"""Tests for TfDocumentModel (term frequency model)."""
...
def test_no_tokenizer_with_string():
    """Test that a string without tokenizer raises ValueError."""
    with pytest.raises(ValueError):
        TfDocumentModel("text without tokenizer")


def test_pretokenized_words():
    """Test model creation with pre-tokenized words."""
...
def test_pretokenized_words_frequencies():
    """Test term frequencies with pre-tokenized words."""
...
def test_magnitude():
    """Test model magnitude computation."""
...
def test_terms():
    """Test that model terms are correctly extracted."""
    tokenizer = Tokenizer("english")
...
def test_term_frequency():
    """Test individual term frequency lookups."""
    tokenizer = Tokenizer("english")
...
def test_most_frequent_terms():
    """Test retrieving the most frequent terms in order."""
    tokenizer = Tokenizer("english")
...
def test_most_frequent_terms_empty():
    """Test most_frequent_terms on an empty model."""
    tokenizer = Tokenizer("english")
...
def test_normalized_words_frequencies():
    """Test normalized term frequency computation."""
...
def test_normalized_words_frequencies_with_smoothing_term():
    """Test normalized term frequency with smoothing term."""
    words = "a b c d e c b d c e e d e d e".split()
    model = TfDocumentModel(tuple(words))
