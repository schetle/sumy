"""Tests for DOM model classes (Document, Paragraph, Sentence)."""
...
def test_unique_words():
    """Test that document.words returns all words from all sentences."""
...
def test_headings():
    """Test that headings are correctly identified in a document."""
...
def test_sentences():
    """Test that sentences are correctly extracted from a document."""
    document = build_document_from_string("""
        Nějaký muž šel kolem naší zahrady
        Nějaký jiný muž šel kolem vaší zahrady
...
def test_only_instances_of_sentence_allowed():
    """Test that Paragraph rejects non-Sentence objects."""
    document = build_document_from_string("""
        Nějaký muž šel kolem naší zahrady
        Nějaký jiný muž šel kolem vaší zahrady
